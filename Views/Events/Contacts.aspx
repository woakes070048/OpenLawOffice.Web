<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<IEnumerable<OpenLawOffice.Web.ViewModels.Events.EventAssignedContactViewModel>>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="listing_table">
        ...
        <tr>
            ...
            <td>
                <%: Html.ActionLink(item.Role, "Details", "EventAssignedContact", new { id = item.Id }, null)%>
            </td>
            <td>
                <%: Html.ActionLink("Edit", "Edit", "EventAssignedContact", new { id = item.Id }, new { @class = "btn-edit", title = "Edit" })%>
                <%: Html.ActionLink("Unassign", "Delete", "EventAssignedContact", new { id = item.Id }, new { @class = "btn-remove", title = "Unassign" })%>
            </td>
        </tr>
        <% } %>
    </table>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MenuContent" runat="server">
    ...
    <ul style="list-style: none outside none; padding-left: 1em;">
        ...
        <li>
            <%: Html.ActionLink("Assign Contact", "SelectContactToAssign", "EventAssignedContact", new { id = RouteData.Values["Id"].ToString() }, null)%></li>
    </ul>
