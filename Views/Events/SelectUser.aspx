<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<IEnumerable<OpenLawOffice.Web.ViewModels.Account.UsersViewModel>>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% foreach (var item in Model) { %>
        ...
        <tr>
            <td>
                <%: Html.ActionLink(item.Username, "UserAgenda", "Events", new { id = item.PId.Value }, null)%>
            </td>
        </tr>
