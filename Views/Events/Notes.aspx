...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>
        Event Notes<a id="pageInfo" class="btn-question" style="padding-left: 15px;">Help</a></h2>
    ...
    <div id="pageInfoDialog" title="Help">
        ...
        Notes allow users to make comments or record information on events.<br /><br />
...
<asp:Content ID="Content3" ContentPlaceHolderID="MenuContent" runat="server">
    ...
    <ul style="list-style: none outside none; padding-left: 1em;">
        <li>
            <%: Html.ActionLink("New Note", "Create", "Notes", new { EventId = RouteData.Values["Id"].ToString() }, null)%></li>
    </ul>
    <li>
