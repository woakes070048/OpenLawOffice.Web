<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/SiteNoRightBar.Master" Inherits="System.Web.Mvc.ViewPage<OpenLawOffice.Web.ViewModels.Billing.BillingGroupViewModel>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="roadmap">
        <div id="current" class="one">Edit Billing Rate<a id="pageInfo" class="btn-question" style="padding-left: 15px;">Help</a></div>
    </div>
    ...
    <div id="pageInfoDialog" title="Help">
        ...
        Fill in the information on this page to modify the billing rate.  Required fields are indicated with an
