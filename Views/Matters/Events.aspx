<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<IEnumerable<OpenLawOffice.Web.ViewModels.Events.EventViewModel>>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="roadmap">
        ...
        <div id="current" class="one">Events for Matter<a id="pageInfo" class="btn-question" style="padding-left: 15px;">Help</a></div>
    </div>
    ...
    <table class="listing_table">
        ...
        <tr>
            ...
            <td>
                ...
                <%: Html.ActionLink("Unassign", "UnlinkEvent", "EventMatter", new { id = item.Id, MatterId = RouteData.Values["Id"] }, new { @class = "btn-remove", title = "Unassign" })%>
            </td>
        </tr>
        <% } %>
    </table>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MenuContent" runat="server">
    ...
    <ul style="list-style: none outside none; padding-left: 1em;">
        <li>
            <%: Html.ActionLink("New Event", "Create", "Events", new { MatterId = RouteData.Values["Id"].ToString() }, null)%></li>
        <li>
            <%: Html.ActionLink("Attach Event", "SelectEvent", "EventMatter", new { id = RouteData.Values["Id"] }, null)%></li>
    </ul>
    <li>
