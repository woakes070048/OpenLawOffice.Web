<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/SiteNoRightBar.Master" Inherits="System.Web.Mvc.ViewPage<IEnumerable<OpenLawOffice.Web.ViewModels.Billing.FeeViewModel>>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="roadmap">
        ...
        <div id="current" class="one">Matter Fees<a id="pageInfo" class="btn-question" style="padding-left: 15px;">Help</a></div>
    </div>
    
    <script language="javascript">
    $(function () {
        $("#add").click(function () {
            window.location = "/Fees/Create?MatterId=<%: ViewData["MatterId"] %>";
        });
    });
    </script>
    ...
    <div id="pageInfoDialog" title="Help">
        ...
        A fee allows for tracking of flat fees and fees (copies, scanning, faxing) incurred throughout the course of the matter which may
