<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/SiteNoRightBar.Master" Inherits="System.Web.Mvc.ViewPage<OpenLawOffice.Web.ViewModels.Billing.ExpenseViewModel>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="roadmap">
        ...
        <div id="current" class="one">Create Expense<a id="pageInfo" class="btn-question" style="padding-left: 15px;">Help</a></div>
    </div>
    ...
    <div id="pageInfoDialog" title="Help">
        ...
        Fill in the information on this page to create a new expense.  Required fields are indicated with an
