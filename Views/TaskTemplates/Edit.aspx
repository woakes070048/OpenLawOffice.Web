...
<asp:Content ID="Contnt1" ContentPlaceHolderID="TitleContent" runat="server">
    Edit Task Template
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    
    <h2>
        Edit Task Template<a id="pageInfo" class="btn-question" style="padding-left: 15px;">Help</a></h2>
    ...
    <div id="pageInfoDialog" title="Help">
        ...
        Fill in the information on this page to modify a task template.  Required fields are indicated with an
