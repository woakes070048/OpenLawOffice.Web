<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<OpenLawOffice.Web.ViewModels.Events.EventResponsibleUserViewModel>" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	Add User Responsibility for Event
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>
        Add User Responsibility for Event<a id="pageInfo" class="btn-question" style="padding-left: 15px;">Help</a></h2>
    ...
    <div id="pageInfoDialog" title="Help">
        ...
        Fill in the information on this page to add a responsible user to the event.  Required fields are indicated with an
