<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<OpenLawOffice.Web.ViewModels.Settings.TagFilterViewModel>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>
        Edit Task Filter<a id="pageInfo" class="btn-question" style="padding-left: 15px;">Help</a></h2>
    ...
    <div id="pageInfoDialog" title="Help">
        ...
        Fill in the information on this page to modify the tag filter.  Required fields are indicated with an
