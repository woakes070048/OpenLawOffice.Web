// -----------------------------------------------------------------------
// <copyright file="EventTagViewModel.cs" company="Nodine Legal, LLC">
...
namespace OpenLawOffice.Web.ViewModels.Events
{
    ...
    [MapMe]
    public class EventTagViewModel : Tagging.TagBaseViewModel
    {
        public EventViewModel Event { get; set; }

        public void BuildMappings()
        {
            Mapper.CreateMap<Common.Models.Events.EventTag, EventTagViewModel>()
            ...
            Mapper.CreateMap<EventTagViewModel, Common.Models.Events.EventTag>()
                .ForMember(dst => dst.Created, opt => opt.MapFrom(src => src.Created))
                .ForMember(dst => dst.Modified, opt => opt.MapFrom(src => src.Modified))
                .ForMember(dst => dst.Disabled, opt => opt.MapFrom(src => src.Disabled))
