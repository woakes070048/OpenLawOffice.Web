// -----------------------------------------------------------------------
// <copyright file="EventResponsibleUserViewModel.cs" company="Nodine Legal, LLC">
...
namespace OpenLawOffice.Web.ViewModels.Events
{
    ...
    public class EventResponsibleUserViewModel : CoreViewModel
    {
        ...
        {
            Mapper.CreateMap<Common.Models.Events.EventResponsibleUser, EventResponsibleUserViewModel>()
            ...
            Mapper.CreateMap<EventResponsibleUserViewModel, Common.Models.Events.EventResponsibleUser>()
                .ForMember(dst => dst.Created, opt => opt.MapFrom(src => src.Created))
                .ForMember(dst => dst.Modified, opt => opt.MapFrom(src => src.Modified))
                .ForMember(dst => dst.Disabled, opt => opt.MapFrom(src => src.Disabled))
                ...
                {
                    if (model.Event == null) return null;
