// -----------------------------------------------------------------------
// <copyright file="FormViewModel.cs" company="Nodine Legal, LLC">
...
namespace OpenLawOffice.Web.ViewModels.Forms
{
    using System;
    using AutoMapper;
    ...
    [MapMe]
    public class FormViewModel : CoreViewModel
    {
        public int? Id { get; set; }

        public string Title { get; set; }

        public Matters.MatterTypeViewModel MatterType { get; set; }

        public HttpPostedFileBase FileUpload { get; set; }

        public void BuildMappings()
        {
            Mapper.CreateMap<Common.Models.Forms.Form, FormViewModel>()
                ...
                .ForMember(dst => dst.Title, opt => opt.MapFrom(src => src.Title))
                .ForMember(dst => dst.FileUpload, opt => opt.Ignore());

            Mapper.CreateMap<FormViewModel, Common.Models.Forms.Form>()
                .ForMember(dst => dst.Created, opt => opt.MapFrom(src => src.Created))
                .ForMember(dst => dst.Modified, opt => opt.MapFrom(src => src.Modified))
                .ForMember(dst => dst.Disabled, opt => opt.MapFrom(src => src.Disabled))
