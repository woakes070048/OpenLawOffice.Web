// -----------------------------------------------------------------------
// <copyright file="FormFieldViewModel.cs" company="Nodine Legal, LLC">
...
namespace OpenLawOffice.Web.ViewModels.Forms
{
    ...
    [MapMe]
    public class FormFieldViewModel : CoreViewModel
    {
        ...
        {
            Mapper.CreateMap<Common.Models.Forms.FormField, FormFieldViewModel>()
            ...
            Mapper.CreateMap<FormFieldViewModel, Common.Models.Forms.FormField>()
                .ForMember(dst => dst.Created, opt => opt.MapFrom(src => src.Created))
                .ForMember(dst => dst.Modified, opt => opt.MapFrom(src => src.Modified))
                .ForMember(dst => dst.Disabled, opt => opt.MapFrom(src => src.Disabled))
