...
namespace OpenLawOffice.Web.ViewModels.Assets
{
    ...
    [MapMe]
    public class SelectableAssetViewModel : AssetViewModel
    {
        ...
        {
            Mapper.CreateMap<Common.Models.Assets.Asset, SelectableAssetViewModel>()
            ...
            Mapper.CreateMap<SelectableAssetViewModel, Common.Models.Assets.Asset>()
                .ForMember(dst => dst.Created, opt => opt.MapFrom(src => src.Created))
                .ForMember(dst => dst.Modified, opt => opt.MapFrom(src => src.Modified))
                .ForMember(dst => dst.Disabled, opt => opt.MapFrom(src => src.Disabled))
