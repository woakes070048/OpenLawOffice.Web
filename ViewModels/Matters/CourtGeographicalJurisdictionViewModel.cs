// -----------------------------------------------------------------------
// <copyright file="MatterTypeViewModel.cs" company="Nodine Legal, LLC">
...
namespace OpenLawOffice.Web.ViewModels.Matters
{
    ...
    [MapMe]
    public class CourtGeographicalJurisdictionViewModel : CoreViewModel
    {
        ...
        {
            Mapper.CreateMap<Common.Models.Matters.CourtGeographicalJurisdiction, CourtGeographicalJurisdictionViewModel>()
            ...
            Mapper.CreateMap<CourtGeographicalJurisdictionViewModel, Common.Models.Matters.CourtGeographicalJurisdiction>()
                .ForMember(dst => dst.Created, opt => opt.MapFrom(src => src.Created))
                .ForMember(dst => dst.Modified, opt => opt.MapFrom(src => src.Modified))
                .ForMember(dst => dst.Disabled, opt => opt.MapFrom(src => src.Disabled))
