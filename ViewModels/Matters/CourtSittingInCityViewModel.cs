...
namespace OpenLawOffice.Web.ViewModels.Matters
{
    ...
    [MapMe]
    public class CourtSittingInCityViewModel : CoreViewModel
    {
        ...
        {
            Mapper.CreateMap<Common.Models.Matters.CourtSittingInCity, CourtSittingInCityViewModel>()
            ...
            Mapper.CreateMap<CourtSittingInCityViewModel, Common.Models.Matters.CourtSittingInCity>()
                .ForMember(dst => dst.Created, opt => opt.MapFrom(src => src.Created))
                .ForMember(dst => dst.Modified, opt => opt.MapFrom(src => src.Modified))
                .ForMember(dst => dst.Disabled, opt => opt.MapFrom(src => src.Disabled))
