// -----------------------------------------------------------------------
// <copyright file="FeeMatterViewModel.cs" company="Nodine Legal, LLC">
...
namespace OpenLawOffice.Web.ViewModels.Billing
{
    ...
    [MapMe]
    public class FeeMatterViewModel : CoreViewModel
    {
        ...
        {
            Mapper.CreateMap<OpenLawOffice.Common.Models.Billing.FeeMatter, FeeMatterViewModel>()
            ...
            Mapper.CreateMap<FeeMatterViewModel, OpenLawOffice.Common.Models.Billing.FeeMatter>()
                .ForMember(dst => dst.Created, opt => opt.MapFrom(src => src.Created))
                .ForMember(dst => dst.Modified, opt => opt.MapFrom(src => src.Modified))
                .ForMember(dst => dst.Disabled, opt => opt.MapFrom(src => src.Disabled))
