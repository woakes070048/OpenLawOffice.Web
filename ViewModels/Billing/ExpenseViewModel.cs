// -----------------------------------------------------------------------
// <copyright file="ExpenseViewModel.cs" company="Nodine Legal, LLC">
...
namespace OpenLawOffice.Web.ViewModels.Billing
{
    ...
    [MapMe]
    public class ExpenseViewModel : CoreViewModel
    {
        ...
        {
            Mapper.CreateMap<Common.Models.Billing.Expense, ExpenseViewModel>()
                ...
                .ForMember(dst => dst.Incurred, opt => opt.MapFrom(src => src.Incurred))
                .ForMember(dst => dst.Paid, opt => opt.MapFrom(src => src.Paid))
                .ForMember(dst => dst.Vendor, opt => opt.MapFrom(src => src.Vendor))
                .ForMember(dst => dst.Amount, opt => opt.MapFrom(src => src.Amount))
                .ForMember(dst => dst.Details, opt => opt.MapFrom(src => src.Details));

            Mapper.CreateMap<ExpenseViewModel, Common.Models.Billing.Expense>()
                .ForMember(dst => dst.Created, opt => opt.MapFrom(src => src.Created))
                .ForMember(dst => dst.Modified, opt => opt.MapFrom(src => src.Modified))
                .ForMember(dst => dst.Disabled, opt => opt.MapFrom(src => src.Disabled))
