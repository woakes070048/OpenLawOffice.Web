// -----------------------------------------------------------------------
// <copyright file="BillingRateViewModel.cs" company="Nodine Legal, LLC">
...
namespace OpenLawOffice.Web.ViewModels.Billing
{
    ...
    [MapMe]
    public class BillingRateViewModel : CoreViewModel
    {
        ...
        {
            Mapper.CreateMap<Common.Models.Billing.BillingRate, BillingRateViewModel>()
            ...
            Mapper.CreateMap<BillingRateViewModel, Common.Models.Billing.BillingRate>()
                .ForMember(dst => dst.Created, opt => opt.MapFrom(src => src.Created))
                .ForMember(dst => dst.Modified, opt => opt.MapFrom(src => src.Modified))
                .ForMember(dst => dst.Disabled, opt => opt.MapFrom(src => src.Disabled))
