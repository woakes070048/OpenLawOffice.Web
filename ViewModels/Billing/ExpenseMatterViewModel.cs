// -----------------------------------------------------------------------
// <copyright file="ExpenseMatterViewModel.cs" company="Nodine Legal, LLC">
...
namespace OpenLawOffice.Web.ViewModels.Billing
{
    ...
    [MapMe]
    public class ExpenseMatterViewModel : CoreViewModel
    {
        ...
        {
            Mapper.CreateMap<OpenLawOffice.Common.Models.Billing.ExpenseMatter, ExpenseMatterViewModel>()
            ...
            Mapper.CreateMap<ExpenseMatterViewModel, OpenLawOffice.Common.Models.Billing.ExpenseMatter>()
                .ForMember(dst => dst.Created, opt => opt.MapFrom(src => src.Created))
                .ForMember(dst => dst.Modified, opt => opt.MapFrom(src => src.Modified))
                .ForMember(dst => dst.Disabled, opt => opt.MapFrom(src => src.Disabled))
