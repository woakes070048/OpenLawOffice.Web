// -----------------------------------------------------------------------
// <copyright file="BillingGroupViewModel.cs" company="Nodine Legal, LLC">
...
namespace OpenLawOffice.Web.ViewModels.Billing
{
    ...
    [MapMe]
    public class BillingGroupViewModel : CoreViewModel
    {
        ...
        {
            Mapper.CreateMap<Common.Models.Billing.BillingGroup, BillingGroupViewModel>()
